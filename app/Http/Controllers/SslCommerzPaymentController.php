...
class SslCommerzPaymentController extends Controller
{
    ...
    public function payViaAjax(Request $request)
    {
      $data = json_decode($request->cart_json);
        ...
        $post_data = array();
        $post_data['total_amount'] = $data->total_amount ?? 0; # You cant not pay less than 10
        $post_data['currency'] = "BDT";
        $post_data['tran_id'] = uniqid(); // tran_id must be unique
        ...
        $post_data['cus_add2'] = "";
        $post_data['cus_notes'] = $data->cus_notes;
        $post_data['cus_state'] =$data->cus_state;
        $post_data['cus_postcode'] = $data->cus_zip;
        $post_data['cus_country'] = $data->cus_country;
        $post_data['cus_phone'] = $data->cus_phone;
        $post_data['cus_fax'] = "";

        # SHIPMENT INFORMATION
        $post_data['ship_name'] = "Store Ecobazar";
        $post_data['ship_add1'] = "Dhaka";
        $post_data['ship_add2'] = "Dhaka";
        $post_data['ship_city'] = "Dhaka";
        $post_data['ship_state'] = "Dhaka";
        ...
        $post_data['shipping_method'] = "NO";
        $post_data['product_name'] = "E-product";
        $post_data['product_category'] = "Goods";
        $post_data['product_profile'] = "physical-goods";
